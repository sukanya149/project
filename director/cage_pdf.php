...
<head>
    ...
    <title>รายงานข้อมูลกรงเลี้ยง</title>
    ...
    <style>
        ...
        /* ปรับให้ข้อความ "ข้อมูลกรงเลี้ยง" อยู่ตรงกลาง */
        .header {
            text-align: center;
            margin-bottom: 20px;
        }
...
<div class="wrapper">
    ...
    <div class="content">
        <!-- ข้อความหัวเรื่อง -->
        <div class="header">
            <h2>รายงานข้อมูลกรงเลี้ยง</h2>
        </div>

        <!-- ปุ่มสำหรับดาวน์โหลด PDF -->
        <div class="download-btn">
            <a href="cage_report_pdf.php" target="_blank" class="btn-blue">ดาวน์โหลดรายงาน PDF</a>
        </div>

        <!-- แสดงตารางข้อมูลกรงเลี้ยง -->
        <table>
            <tr>
            ...
            if ($stmt->rowCount() > 0) {
                ...
                echo '<tr><td colspan="4">ไม่พบข้อมูลกรงเลี้ยง</td></tr>';
            }
            ?>
        </table>
    </div>
