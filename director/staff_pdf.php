...
// ดึงข้อมูลพนักงานจากฐานข้อมูลด้วย PDO
...
<head>
    ...
    <title>รายงานข้อมูลบุคลากร</title>
    ...
    <style>
        ...
        /* ปรับให้ข้อความ "ข้อมูลพนักงาน" อยู่ตรงกลาง */
        .header {
            text-align: center;
            margin-bottom: 20px;
        }
    ...
    <div class="content">
        ...
        <div class="header">
           ...
           <div class="download-btn">
            <a href="staff_report_pdf.php" target="_blank" class="btn-blue">ดาวน์โหลดรายงาน PDF</a>
        </div>

        <!-- แสดงตารางข้อมูลพนักงาน -->
        <table>
            <tr>
